...
/**
 * Display a list of lecture titles as clickable links.
 */
export async function showLecturesList(root, lecturesJson, type) {
  root.innerHTML = `<h2>${lecturesJson.title}</h2><p>Select a lecture to view details:</p>`;
...
/**
 * Display details for a specific lecture, rendering various content types.
 */
